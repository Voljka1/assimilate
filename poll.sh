...
if [ "$#" -lt 1 ]; then
    clear
    echo "---------------------------------------------------------------------"
    echo "Usage: ./poll.sh device_id [module] [debug_level] [-who]"
    ...
    echo "  ./poll.sh 20"
    echo "  ./poll.sh 20 vv"
    echo "  ./poll.sh 20 sensors"
    echo "  ./poll.sh 20 sensors vv"
    echo "  ./poll.sh 20 -who"
    echo "  ./poll.sh 20 os -who"
    exit 1
fi
...
# ---- WHO MODE ----
if $WHO; then
    CMD="lnms device:poll $DEVICE_ID"
